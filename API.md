...
| GET | `/classes/:classId/attendance/roll` | 🔑 `attendance.read` · 📦 `attendance` | Who was on the class's roll on ?date=YYYY-MM-DD — the pupils a register for that day must cover. |
