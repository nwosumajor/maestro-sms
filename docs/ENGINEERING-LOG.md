...
taken against — not the case law. The recurring RULES were distilled into
**“Defect classes that keep recurring”** in `CLAUDE.md`; this is where the
instances live, in full, with nothing removed.

## How to use it

- **Before fixing something, grep here for its shape.** Most defects in this
  repo are the second or third instance of a class already written up — a naira
  constant applied to every currency, a guard on one of two write paths, a
  sibling left behind. The entry that names your class usually names the sweep
  that finds the rest.
- **The `// GOTCHA` lines are the highest-value text in this file.** They record
  mistakes made *while fixing*, which is where the same hour gets lost twice.
- **Entries are chronological, not thematic**, and deliberately so. Most span
  two or three areas, and filing one under a single heading would hide it from
  everybody looking in the other. Grep beats a taxonomy here.
...
- [Thirteen doors onto a scholarship paper, and the listing that contradicted the refusal](#thirteen-doors-onto-a-scholarship-paper-and-the-listing-that-contradicted-the-refusal)
- [A leave entitlement of 200 days, and no way back](#a-leave-entitlement-of-200-days-and-no-way-back)
- [The school held the answer key after all — through the BANK](#the-school-held-the-answer-key-after-all--through-the-bank)
- [A bank that could only be created, saved or destroyed — mine](#a-bank-that-could-only-be-created-saved-or-destroyed--mine)
- [A promo budget of one, spent three times](#a-promo-budget-of-one-spent-three-times)
- [A last working day of 31 April, filed in May](#a-last-working-day-of-31-april-filed-in-may)
- [A typo in "late after", and nobody was ever late again](#a-typo-in-late-after-and-nobody-was-ever-late-again)
- [A gate code that had expired, in a 4xl font](#a-gate-code-that-had-expired-in-a-4xl-font)
- [A class of thirty-one, and the quiz stopped moving](#a-class-of-thirty-one-and-the-quiz-stopped-moving)
- [The limiter ate the exam, and the screen said the answer was saved](#the-limiter-ate-the-exam-and-the-screen-said-the-answer-was-saved)
- [A question library with no way to write a paper into it](#a-question-library-with-no-way-to-write-a-paper-into-it)
- [Named as the approver, and shown none of what the decision turns on](#named-as-the-approver-and-shown-none-of-what-the-decision-turns-on)
- [A test that asked the server what day it was, in a suite about not doing that](#a-test-that-asked-the-server-what-day-it-was-in-a-suite-about-not-doing-that)
- [Sixty schools, eighteen countries, and every module driven with WRITES](#sixty-schools-eighteen-countries-and-every-module-driven-with-writes)
- [A fix that shipped with no door, and the gate that vouched for it](#a-fix-that-shipped-with-no-door-and-the-gate-that-vouched-for-it)
- [Fifty schools, sixteen countries, a full session — driven](#fifty-schools-sixteen-countries-a-full-session--driven)
- [Three nightly sweeps that opened a transaction per person](#three-nightly-sweeps-that-opened-a-transaction-per-person)
- [A school could not import its own roll, and the API stopped for everyone](#a-school-could-not-import-its-own-roll-and-the-api-stopped-for-everyone)
- [The clock and the map were at the top of a paper forty questions long](#the-clock-and-the-map-were-at-the-top-of-a-paper-forty-questions-long)
- [The notice said EXPIRED; the register said "expires (-823d)"](#the-notice-said-expired-the-register-said-expires--823d)
- [A feature that cannot be found is not delivered](#a-feature-that-cannot-be-found-is-not-delivered)
- [The school earned three free months and nobody who works there was told](#the-school-earned-three-free-months-and-nobody-who-works-there-was-told)
- [A question written once, and reused for years](#a-question-written-once-and-reused-for-years)
- [A paper exam whose questions could not be written, or printed](#a-paper-exam-whose-questions-could-not-be-written-or-printed)
- [A meeting announced to every guardian, called off in silence](#a-meeting-announced-to-every-guardian-called-off-in-silence)
- [A scholarship denominated in one country's money, offered to thirty-seven](#a-scholarship-denominated-in-one-countrys-money-offered-to-thirty-seven)
- [An announce that could not reach 5,000, and a prize the biggest school always won](#an-announce-that-could-not-reach-5000-and-a-prize-the-biggest-school-always-won)
- [5,000 applicants, driven — and the queue could see 500 of them](#5000-applicants-driven--and-the-queue-could-see-500-of-them)
- [A paper exam that could be set, sat, and never marked](#a-paper-exam-that-could-be-set-sat-and-never-marked)
- [One paper per subject, derived from the questions](#one-paper-per-subject-derived-from-the-questions)
- [Results every school can read, and no child is named in](#results-every-school-can-read-and-no-child-is-named-in)
- [The prize that no screen mentioned](#the-prize-that-no-screen-mentioned)
- [A prize for the school, held beside what it bought](#a-prize-for-the-school-held-beside-what-it-bought)
- [Each school held the answer key to the competition it was entering](#each-school-held-the-answer-key-to-the-competition-it-was-entering)
- [One fix cancelling another, found only by exercising the flow](#one-fix-cancelling-another-found-only-by-exercising-the-flow)
- [A path glob in a comment, and sixty-three blind gates](#a-path-glob-in-a-comment-and-sixty-three-blind-gates)
- [A scholarship exam the candidate's school had to have paid for](#a-scholarship-exam-the-candidates-school-had-to-have-paid-for)
- [Two ways a scholarship reached nobody, both reported as a success](#two-ways-a-scholarship-reached-nobody-both-reported-as-a-success)
- [Every appraisal named HR as the reviewer](#every-appraisal-named-hr-as-the-reviewer)
- [An exam paper that could only be added to](#an-exam-paper-that-could-only-be-added-to)
- [A librarian who could only lend books to themselves](#a-librarian-who-could-only-lend-books-to-themselves)
- [A fifth probe: no response carries ciphertext or a credential](#a-fifth-probe-no-response-carries-ciphertext-or-a-credential)
- [A run-rate computed in naira for every school on the platform](#a-run-rate-computed-in-naira-for-every-school-on-the-platform)
- [A British school offered the National Housing Fund](#a-british-school-offered-the-national-housing-fund)
- [Twelve rows offered, seven accepted](#twelve-rows-offered-seven-accepted)
- [The cedi option was labelled "$ US Dollar"](#the-cedi-option-was-labelled--us-dollar)
- [Five boot assertions, and knowing our own address](#five-boot-assertions-and-knowing-our-own-address)
- [An environment variable set to an EMPTY STRING is not unset](#an-environment-variable-set-to-an-empty-string-is-not-unset)
- [A secret's SHAPE is not its PROVENANCE](#a-secrets-shape-is-not-its-provenance)
- [The signing key was printed in the example file](#the-signing-key-was-printed-in-the-example-file)
- [A mis-set encryption key disabled encryption in SILENCE](#a-mis-set-encryption-key-disabled-encryption-in-silence)
- [The storage provider is decided ONCE, and an unknown value refuses to boot](#the-storage-provider-is-decided-once-and-an-unknown-value-refuses-to-boot)
- [An approver is somebody who is still here](#an-approver-is-somebody-who-is-still-here)
- [Work is only ever given to somebody who is still here](#work-is-only-ever-given-to-somebody-who-is-still-here)
- [The inbox is a record, and a trigram index under RLS is not an index](#the-inbox-is-a-record-and-a-trigram-index-under-rls-is-not-an-index)
- [A list that grows with a school's LIFETIME, not its size](#a-list-that-grows-with-a-schools-lifetime-not-its-size)
- [The same measurement, applied to the other big reads](#the-same-measurement-applied-to-the-other-big-reads)
- [A paid module's controller with no entitlement tag is a free feature](#a-paid-modules-controller-with-no-entitlement-tag-is-a-free-feature)
- [The front door, and the one place a rate limit would lose money](#the-front-door-and-the-one-place-a-rate-limit-would-lose-money)
- ["Every mutation writes an audit-log entry" — checked, not assumed](#every-mutation-writes-an-audit-log-entry--checked-not-assumed)
- [The weaker action re-authenticated and the stronger one did not](#the-weaker-action-re-authenticated-and-the-stronger-one-did-not)
- [Two producers of the same telemetry, one consent-gated and one not](#two-producers-of-the-same-telemetry-one-consent-gated-and-one-not)
- [The bundle said COMPLETE and read 8 of the 33 tables keyed on a pupil](#the-bundle-said-complete-and-read-8-of-the-33-tables-keyed-on-a-pupil)
- [The right to erasure reached the homework and not the birth certificate](#the-right-to-erasure-reached-the-homework-and-not-the-birth-certificate)
- [The replica answers a read only if it can answer it correctly](#the-replica-answers-a-read-only-if-it-can-answer-it-correctly)
- [One request body of 339 was never validated](#one-request-body-of-339-was-never-validated)
- [A broken bar where the naira should be](#a-broken-bar-where-the-naira-should-be)
- [Six definitions of one child's attendance rate](#six-definitions-of-one-childs-attendance-rate)
- [A register for a day that has not happened](#a-register-for-a-day-that-has-not-happened)
- [An archive labelled with a term that held every term](#an-archive-labelled-with-a-term-that-held-every-term)
- [A backup a school can actually take away](#a-backup-a-school-can-actually-take-away)
- [Fifteen years of registers, and the only table with no way out](#fifteen-years-of-registers-and-the-only-table-with-no-way-out)
- [Is it accurate and efficient? — measured, and one of the answers was no](#is-it-accurate-and-efficient--measured-and-one-of-the-answers-was-no)
- [Funds separated by the part of the school that raised them](#funds-separated-by-the-part-of-the-school-that-raised-them)
- [The person driving the bus does not need to know what each family pays](#the-person-driving-the-bus-does-not-need-to-know-what-each-family-pays)
- [A final month the school had already paid, paid again](#a-final-month-the-school-had-already-paid-paid-again)
- [A statutory clock that nobody was watching](#a-statutory-clock-that-nobody-was-watching)
- [A tenant's data is not somebody else's cache entry](#a-tenants-data-is-not-somebody-elses-cache-entry)
- [The clock stopped and the family was never told](#the-clock-stopped-and-the-family-was-never-told)
- [Holding ₦23,300 for a school it owed ₦22,000 and $1,300](#holding-23300-for-a-school-it-owed-22000-and-1300)
- [A pupil made the subject teacher of English](#a-pupil-made-the-subject-teacher-of-english)
- [Told to ask a class teacher the class has not got](#told-to-ask-a-class-teacher-the-class-has-not-got)
- [The two accesses the model turns on, driven and pinned](#the-two-accesses-the-model-turns-on-driven-and-pinned)
- [Step 4 DONE: `class_teacher` retired, and the order that made it possible](#step-4-done-class_teacher-retired-and-the-order-that-made-it-possible)
- [Every class has a class teacher — required at creation, never removable](#every-class-has-a-class-teacher--required-at-creation-never-removable)
- [A class teacher IS the class supervisor, and could not take their own register](#a-class-teacher-is-the-class-supervisor-and-could-not-take-their-own-register)
- [Four answers to "do I teach this child", and a teacher of 899 who saw none](#four-answers-to-do-i-teach-this-child-and-a-teacher-of-899-who-saw-none)
- [A filter the caller could not satisfy, answered with somebody else](#a-filter-the-caller-could-not-satisfy-answered-with-somebody-else)
- [A decision that failed, on the queue where schools wait to be let in](#a-decision-that-failed-on-the-queue-where-schools-wait-to-be-let-in)
- [The gate for a translation nobody sends, and a guard driven for the first time](#the-gate-for-a-translation-nobody-sends-and-a-guard-driven-for-the-first-time)
- [Five translations with no producer, and the parent who was never told](#five-translations-with-no-producer-and-the-parent-who-was-never-told)
- [The half of the clock sweep that keyed on the wrong thing](#the-half-of-the-clock-sweep-that-keyed-on-the-wrong-thing)
- [The cohosts were checked three ways and the host not at all](#the-cohosts-were-checked-three-ways-and-the-host-not-at-all)
- [The date on a receipt, and the sweep that found the rest of them](#the-date-on-a-receipt-and-the-sweep-that-found-the-rest-of-them)
- [A chargeback deadline, a day late, on the notice that says "lost by default"](#a-chargeback-deadline-a-day-late-on-the-notice-that-says-lost-by-default)
- [The money followed the school and the clock did not](#the-money-followed-the-school-and-the-clock-did-not)
- [A fifth probe: no request, ordinary or hostile, is a 500](#a-fifth-probe-no-request-ordinary-or-hostile-is-a-500)
- [The question paper was proved to reach the right people, never to be safe](#the-question-paper-was-proved-to-reach-the-right-people-never-to-be-safe)
- [The receipt was proved to be a PDF, never to be the right one](#the-receipt-was-proved-to-be-a-pdf-never-to-be-the-right-one)
- [The teacher said they cannot teach then, and only the generator listened](#the-teacher-said-they-cannot-teach-then-and-only-the-generator-listened)
- [The gate that polices gates could not see five of them](#the-gate-that-polices-gates-could-not-see-five-of-them)
- [A floor of twenty under a gate that was covering two hundred](#a-floor-of-twenty-under-a-gate-that-was-covering-two-hundred)
- ["You have no children linked" was also what a refusal looked like](#you-have-no-children-linked-was-also-what-a-refusal-looked-like)
- [The access review counted elevations the API already refused](#the-access-review-counted-elevations-the-api-already-refused)
- [Two more promises the help page could not keep](#two-more-promises-the-help-page-could-not-keep)
- [The manual promised a power the button does not have](#the-manual-promised-a-power-the-button-does-not-have)
- [A gate that checked thirteen of eighteen jobs](#a-gate-that-checked-thirteen-of-eighteen-jobs)
- [A teaching licence that lapsed, still ticked off as held](#a-teaching-licence-that-lapsed-still-ticked-off-as-held)
- [The screens that make a per-stop fare usable](#the-screens-that-make-a-per-stop-fare-usable)
- [A fee run that billed nobody, for a bus carrying five children](#a-fee-run-that-billed-nobody-for-a-bus-carrying-five-children)
- [A field the API accepted, the sweep required, and no screen could fill in](#a-field-the-api-accepted-the-sweep-required-and-no-screen-could-fill-in)
- [The note that made a revision request worth sending](#the-note-that-made-a-revision-request-worth-sending)
- [The board vetoed an appointment and the person kept the role](#the-board-vetoed-an-appointment-and-the-person-kept-the-role)
- [A grant that answered "not found" to every row](#a-grant-that-answered-not-found-to-every-row)
- [The admissions funnel, driven end to end — and it is sound](#the-admissions-funnel-driven-end-to-end--and-it-is-sound)
- [Seeing a record and destroying it were the same question](#seeing-a-record-and-destroying-it-were-the-same-question)
- [A teacher seated for the exam, and a candidate who is nobody](#a-teacher-seated-for-the-exam-and-a-candidate-who-is-nobody)
- [Selling a school its subscription in its own currency (GHS)](#selling-a-school-its-subscription-in-its-own-currency-ghs)
- [GHS on the dashboard, naira on the billing page — and both were right](#ghs-on-the-dashboard-naira-on-the-billing-page--and-both-were-right)
- [A calendar that could only hold an instant, and a term of assemblies on one day](#a-calendar-that-could-only-hold-an-instant-and-a-term-of-assemblies-on-one-day)
- [A document about yourself, and a fresh install that could not read enrolments](#a-document-about-yourself-and-a-fresh-install-that-could-not-read-enrolments)
- [Every new hire was recorded as already confirmed](#every-new-hire-was-recorded-as-already-confirmed)
- [A sick note nobody could see, and a fix I had to abandon halfway](#a-sick-note-nobody-could-see-and-a-fix-i-had-to-abandon-halfway)
- [Only the SEEDED document requirements could ever expire](#only-the-seeded-document-requirements-could-ever-expire)
- [A lesson that could be filed against its plan once, and never put back](#a-lesson-that-could-be-filed-against-its-plan-once-and-never-put-back)
- [The agent who signs a school up and is credited with nothing](#the-agent-who-signs-a-school-up-and-is-credited-with-nothing)
- [Reviewing the whole web surface, and a rule for the next time](#reviewing-the-whole-web-surface-and-a-rule-for-the-next-time)
- [Four owner decisions, taken](#four-owner-decisions-taken)
- [Told when their child is due back, on the server's clock](#told-when-their-child-is-due-back-on-the-servers-clock)
- [A remark signed by the class teacher, written by whoever went last](#a-remark-signed-by-the-class-teacher-written-by-whoever-went-last)
- [Reviewing my own new screen: a count the page could not see](#reviewing-my-own-new-screen-a-count-the-page-could-not-see)
- [The append-only claim, checked at the grant](#the-append-only-claim-checked-at-the-grant)
- [Two more claims checked: game secrets, and medical ciphertext](#two-more-claims-checked-game-secrets-and-medical-ciphertext)
- [A withdrawn consent that never left the cross-school arena](#a-withdrawn-consent-that-never-left-the-cross-school-arena)
- [An alumni broadcast that reached nobody and said it had](#an-alumni-broadcast-that-reached-nobody-and-said-it-had)
- [A scheme of work whose rows lost their identity](#a-scheme-of-work-whose-rows-lost-their-identity)
- ["Overdue" told to the person who had already finished it](#overdue-told-to-the-person-who-had-already-finished-it)
- [Four scholarships awarded, none credited, and a screen saying otherwise](#four-scholarships-awarded-none-credited-and-a-screen-saying-otherwise)
- [The exam hall, driven for the first time — and a false finding of my own](#the-exam-hall-driven-for-the-first-time--and-a-false-finding-of-my-own)
- [The Golden Rules, checked against the running database](#the-golden-rules-checked-against-the-running-database)
- [A pupil with a staff disciplinary file](#a-pupil-with-a-staff-disciplinary-file)
- [An invite link that was a session](#an-invite-link-that-was-a-session)
- [A ledger that was quietly ten thousand rows long](#a-ledger-that-was-quietly-ten-thousand-rows-long)
- [An archive of scores against identifiers that resolve to nothing](#an-archive-of-scores-against-identifiers-that-resolve-to-nothing)
- [The bundle said COMPLETE again, and a pupil is also a USER](#the-bundle-said-complete-again-and-a-pupil-is-also-a-user)
- [The rule was written down 290 lines above, and the sweep did not follow it](#the-rule-was-written-down-290-lines-above-and-the-sweep-did-not-follow-it)
- [A payment plan that stopped matching the bill](#a-payment-plan-that-stopped-matching-the-bill)
- [A staff calendar the staff could not see](#a-staff-calendar-the-staff-could-not-see)
- [The role most likely to be over-exposed was the one never tested](#the-role-most-likely-to-be-over-exposed-was-the-one-never-tested)
- [The isolation probe passed while nobody was signed in](#the-isolation-probe-passed-while-nobody-was-signed-in)
- [A guardian attached to somebody who is not a pupil](#a-guardian-attached-to-somebody-who-is-not-a-pupil)
- [A certificate that expired, and a sweep that stopped mentioning it](#a-certificate-that-expired-and-a-sweep-that-stopped-mentioning-it)
- [A front door for printing a class's report cards](#a-front-door-for-printing-a-classs-report-cards)
- [Every term's report card was filed under the same name](#every-terms-report-card-was-filed-under-the-same-name)
- [A boarding roll call that named nobody missing](#a-boarding-roll-call-that-named-nobody-missing)
- [The probe's other blind spot: resources addressed by their OWN id](#the-probes-other-blind-spot-resources-addressed-by-their-own-id)
- [A broadsheet that dropped whoever had left, and moved everyone else's rank](#a-broadsheet-that-dropped-whoever-had-left-and-moved-everyone-elses-rank)
- [A register that could not be corrected once the pupil changed class](#a-register-that-could-not-be-corrected-once-the-pupil-changed-class)
- [The receivables aging reconciles, and the refund-sign class is closed](#the-receivables-aging-reconciles-and-the-refund-sign-class-is-closed)
- [The fee reminder counted a refund as a payment](#the-fee-reminder-counted-a-refund-as-a-payment)
- [A task due date that had passed, in the same grey as one due next week](#a-task-due-date-that-had-passed-in-the-same-grey-as-one-due-next-week)
- [Every always-on page audited for calls into gated modules](#every-always-on-page-audited-for-calls-into-gated-modules)
- [A warning the entry tier could never clear](#a-warning-the-entry-tier-could-never-clear)
- [A control the product imposes and gives no way to finish](#a-control-the-product-imposes-and-gives-no-way-to-finish)
- [A pure solver that spent the transaction on arithmetic](#a-pure-solver-that-spent-the-transaction-on-arithmetic)
- [A raise dated for October, paid from August](#a-raise-dated-for-october-paid-from-august)
- [Locked out during their own last working day](#locked-out-during-their-own-last-working-day)
- [A record store that only ever showed the recent page](#a-record-store-that-only-ever-showed-the-recent-page)
- [The row lock that reached the database before the id was ever checked](#the-row-lock-that-reached-the-database-before-the-id-was-ever-checked)
- [The hall shrank under the candidates already seated in it](#the-hall-shrank-under-the-candidates-already-seated-in-it)
- [The bus shrank under the children already on it](#the-bus-shrank-under-the-children-already-on-it)
- [A bill the family was told about, withdrawn in silence](#a-bill-the-family-was-told-about-withdrawn-in-silence)
- [The same absence, emailed twice, and the correction never sent](#the-same-absence-emailed-twice-and-the-correction-never-sent)
- [The family was told the child boarded, and never that they had not](#the-family-was-told-the-child-boarded-and-never-that-they-had-not)
- [The column was denormalised to prune, and eight readers never used it](#the-column-was-denormalised-to-prune-and-eight-readers-never-used-it)
- [Every check-in at the scan desk was a 500, and recorded nothing at all](#every-check-in-at-the-scan-desk-was-a-500-and-recorded-nothing-at-all)
- [A lead that never said how long it had waited](#a-lead-that-never-said-how-long-it-had-waited)
- [The country the prospect typed, and the school that never heard it](#the-country-the-prospect-typed-and-the-school-that-never-heard-it)
- [A salary rendered in a currency the school does not pay in](#a-salary-rendered-in-a-currency-the-school-does-not-pay-in)
- [A name lookup once per row](#a-name-lookup-once-per-row)
- [The operator console rendered a school's money in the platform's naira](#the-operator-console-rendered-a-schools-money-in-the-platforms-naira)
- [A NGN 350 library fine billed as USD 350.00](#a-ngn-350-library-fine-billed-as-usd-35000)
- [A NGN 2,500 late-fee policy that charged a family USD 2,500.00](#a-ngn-2500-late-fee-policy-that-charged-a-family-usd-250000)
- [The meeting-request chain, and the paging change tested against itself](#the-meeting-request-chain-and-the-paging-change-tested-against-itself)
- [The exeat chain — a child-safety flow, driven for the first time and sound](#the-exeat-chain--a-child-safety-flow-driven-for-the-first-time-and-sound)
- [Hiding the name is not enough while the row carries the instant](#hiding-the-name-is-not-enough-while-the-row-carries-the-instant)
- [A pupil told the classmate in front of them is "not in this school"](#a-pupil-told-the-classmate-in-front-of-them-is-not-in-this-school)
- [Global search — the probes' blind spot, checked and sound](#global-search--the-probes-blind-spot-checked-and-sound)
- [The runbook's most important command, pointed at the wrong port](#the-runbooks-most-important-command-pointed-at-the-wrong-port)
- [The family-scope probe cried wolf about the one case it never tested](#the-family-scope-probe-cried-wolf-about-the-one-case-it-never-tested)
- [A three-stage chain approving "Leave: Annual" and nothing else](#a-three-stage-chain-approving-leave-annual-and-nothing-else)
- [The term lock was checked when the amendment was raised, not when it applied](#the-term-lock-was-checked-when-the-amendment-was-raised-not-when-it-applied)
- [An archive that named what it held and never what it did not](#an-archive-that-named-what-it-held-and-never-what-it-did-not)
- [One definition of "paid", and three places that could not express it](#one-definition-of-paid-and-three-places-that-could-not-express-it)
- [A renewal erased the fine that had already accrued](#a-renewal-erased-the-fine-that-had-already-accrued)
- [The guard was at creation; the bytes leave up to a day later](#the-guard-was-at-creation-the-bytes-leave-up-to-a-day-later)
- [Wait for the timer, read the answer, post it back](#wait-for-the-timer-read-the-answer-post-it-back)
- [The operator directory named the admin who had left](#the-operator-directory-named-the-admin-who-had-left)
- [A letter dated a day early, and a duty withdrawn for a lesson already taught](#a-letter-dated-a-day-early-and-a-duty-withdrawn-for-a-lesson-already-taught)
- [The cap bounding what a parent pays was a naira figure, in every currency](#the-cap-bounding-what-a-parent-pays-was-a-naira-figure-in-every-currency)
- [A naira figure, quoted in dollars, on the add-on price list](#a-naira-figure-quoted-in-dollars-on-the-add-on-price-list)
- [A birth certificate the school erased, still ticked off as held](#a-birth-certificate-the-school-erased-still-ticked-off-as-held)
- [One invisible character, and the SMS bill doubles](#one-invisible-character-and-the-sms-bill-doubles)
- [A child whose name the report card could not print](#a-child-whose-name-the-report-card-could-not-print)
- [A review queue that could only see the page it had just decided](#a-review-queue-that-could-only-see-the-page-it-had-just-decided)
- [The window a caller typed, the window the query used](#the-window-a-caller-typed-the-window-the-query-used)
- [A page number nobody validated turned a typo into an incident](#a-page-number-nobody-validated-turned-a-typo-into-an-incident)
- [A refusal must not confirm what it hides](#a-refusal-must-not-confirm-what-it-hides)
- [A gate that walks must say it scanned something](#a-gate-that-walks-must-say-it-scanned-something)
- [The dashboard headcount counted children who had left](#the-dashboard-headcount-counted-children-who-had-left)
- [The bank list counted every question the school had ever written](#the-bank-list-counted-every-question-the-school-had-ever-written)
- [A question bank outlives the teacher who wrote it](#a-question-bank-outlives-the-teacher-who-wrote-it)
- [A leaver's duties are named, never silently reassigned](#a-leavers-duties-are-named-never-silently-reassigned)
- [The family-scope probe derives its own surface, and compares BODIES](#the-family-scope-probe-derives-its-own-surface-and-compares-bodies)
- [An anonymous vote is only anonymous if the LOG agrees](#an-anonymous-vote-is-only-anonymous-if-the-log-agrees)
- [Sentry gets the exception, and nothing from the request](#sentry-gets-the-exception-and-nothing-from-the-request)
- [A duty that is given with a notice is taken away with one](#a-duty-that-is-given-with-a-notice-is-taken-away-with-one)
- [A clash check that reads and then writes is not a clash check](#a-clash-check-that-reads-and-then-writes-is-not-a-clash-check)
- [One school's failure must not end the fleet's sweep](#one-schools-failure-must-not-end-the-fleets-sweep)
- [Every text control can be named by a screen reader](#every-text-control-can-be-named-by-a-screen-reader)
- [A theory mark that was awarded, recorded, and then not shown](#a-theory-mark-that-was-awarded-recorded-and-then-not-shown)
- [A filter nobody validated answers a question nobody asked](#a-filter-nobody-validated-answers-a-question-nobody-asked)
- [Told it does not exist, on the screen that is showing it](#told-it-does-not-exist-on-the-screen-that-is-showing-it)
- [The only report cards carrying a promotion line were the ones with bad news](#the-only-report-cards-carrying-a-promotion-line-were-the-ones-with-bad-news)
- [A registry note that named a file which never existed](#a-registry-note-that-named-a-file-which-never-existed)
- [Two handlers, one URL, and the second one is dead](#two-handlers-one-url-and-the-second-one-is-dead)
- [A hall, a date, a class — and no family ever heard of it](#a-hall-a-date-a-class--and-no-family-ever-heard-of-it)
- [Four zeros on a report card, for a term that had not started](#four-zeros-on-a-report-card-for-a-term-that-had-not-started)
- [One school's currency stopped metering the whole fleet](#one-schools-currency-stopped-metering-the-whole-fleet)
- [Earned, unbilled, and on no screen](#earned-unbilled-and-on-no-screen)
- [One field meaning two things, and a charge nobody could stop](#one-field-meaning-two-things-and-a-charge-nobody-could-stop)
- [Two seconds on the busiest finance screen, and a ledger that could not say what was bought](#two-seconds-on-the-busiest-finance-screen-and-a-ledger-that-could-not-say-what-was-bought)
- [A total that added two currencies, on six screens at once](#a-total-that-added-two-currencies-on-six-screens-at-once)
- [A credit balance was a number, with nothing said of what money it was](#a-credit-balance-was-a-number-with-nothing-said-of-what-money-it-was)
- [The safety net nobody was told about](#the-safety-net-nobody-was-told-about)
- [Thirteen controls that remove something and announce nothing](#thirteen-controls-that-remove-something-and-announce-nothing)
- [The staff page showed "Staff member" where a name should be](#the-staff-page-showed-staff-member-where-a-name-should-be)
- [The banner counting unanswered chargebacks could not see the old ones](#the-banner-counting-unanswered-chargebacks-could-not-see-the-old-ones)
- [Six gates each grew their own route extractor, and five were wrong](#six-gates-each-grew-their-own-route-extractor-and-five-were-wrong)
- [The accident gate now covers every test tree, and the HAYSTACK not just the needle](#the-accident-gate-now-covers-every-test-tree-and-the-haystack-not-just-the-needle)
- [A suspended school is TOLD, at the screen it actually reaches](#a-suspended-school-is-told-at-the-screen-it-actually-reaches)
- [A switched-off school reaches NOTHING, and only the owner switches it back](#a-switched-off-school-reaches-nothing-and-only-the-owner-switches-it-back)
- [A school the operator switched off is left alone](#a-school-the-operator-switched-off-is-left-alone)
- [Nothing reaches a switched-off school, and no money posts to it](#nothing-reaches-a-switched-off-school-and-no-money-posts-to-it)
...
SUBJECT teacher is a `class_subject_teacher` row. `common/teaches.ts` answers
"which classes are mine" from those two links and nothing else.
**THE FIRST ATTEMPT WAS REVERTED, AND THE ONLY DIFFERENCE THE SECOND TIME WAS
THE ORDER.** Sources first left every intermediate state red, ~31 fixtures to
guess at, and an automated translation that took the suite from 29 failing to
44. Done as: **(A)** add the two link stubs to every fixture while the table
still exists — suite green; **(B)** route the ~40 reads through four helpers
(`classIdsTaughtBy`, `teachesClass`, `teachesAnyOf`, `teacherIdsOfClasses`) —
the helper still read the old table, so still green; **(C)** drop the table from
the DEFINITION, which named exactly the fixtures carrying data rather than
shape; **(D)** stop writing, remove the model, migrate. Each step's failures
were a short, honest list instead of a wall.
// **THE FIXTURE LESSON, over and over: HONOUR THE WHERE.** `class.findMany` now
answers two different questions — "which classes do I run" (by `supervisorId`)
and "what are these called" (by `id`) — and a stub answering both the same way
either makes every caller a class teacher or leaves a class named by its bare
id. Both failures happened, in `subject-offering-scope` and in the staff
handover.
// FOUR TESTS ASSERTED THE OLD BEHAVIOUR and were rewritten to the rule rather
than patched: removing a class teacher now REFUSES (it is a hand-over), the
roster has no teacher list to order, `who-may-message` asserted the source
named the retired table, and the class overview counted join rows.
// `DELETE /classes/:classId/teachers/:teacherId` is now exempt from the
audit gate with a reason: it mutates nothing — it refuses and names the
hand-over — and auditing a refusal fills the log with rejected clicks.
// VERIFIED, not assumed: all **229 migrations replay onto a fresh database**
and the table is absent; the backfill kept History 101's class teacher across
the drop; live, assign 201, remove 400 with the hand-over sentence, and the
teacher's roster still 200. Suite 519/5,222, web 182, route smoke 108 routes.
// GOTCHA: the TEST database had a failed migration from an earlier session, so
`migrate deploy` refused with P3009 and the drop had to be applied by hand
there. Worth knowing before concluding a migration is broken.
// STILL NULLABLE, deliberately, and this has not changed: 30 classes have no
class teacher and there is no correct value to invent for them. The API stops
the gap being re-created; NOT NULL belongs to the day that report reads zero.
