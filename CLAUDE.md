...
|---|---|
| `docs/ENGINEERING-LOG.md` | **248 written-up fixes** — what was wrong, how it was measured, what was decided and why, and the `// GOTCHA` lines. Distilled into "Defect classes that keep recurring" below. **Grep it for a defect's shape before fixing one.** |
...
Distilled from **248 written-up fixes in `docs/ENGINEERING-LOG.md`** — the case
