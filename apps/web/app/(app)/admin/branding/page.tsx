  ...
  return (
    <AppShell schoolName={user.schoolName} userName={user.name ?? "User"} active="admin" permissions={user.permissions}>
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">School branding</h1>
          <p className="mt-1 text-sm text-muted-foreground">
            Upload your school&apos;s logo for the branded login page. It&apos;s a paid-plan perk — automatically hidden if the subscription lapses past the grace period.
          </p>
        </div>
