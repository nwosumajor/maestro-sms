        ...
        {isParent && (
          <Guide
            ...
            steps={[
              ...
              { title: "Pay fees online", body: "Fees: open an invoice and pay the outstanding balance by card from your phone. The receipt (with the new balance) lands in Notifications, by email, and in Documents. Overpayments are flagged to the school's finance staff for refund." },
        ...
        {(can("fee.approve") || (can("fee.manage") && !can("rbac.manage"))) && (
          <Guide
            ...
            steps={[
              ...
              { title: "Receipts send themselves", body: "Every posted payment — cash you record or a card payment online, partial or full — automatically receipts the payer, the guardians and the student, with the new balance. Overpayments (e.g. two guardians paying the same invoice) are flagged to you as refund-due; approved card refunds are pushed back to the original card." },
              ...
              { title: "Read the reports", body: "Fees → Reports: receivables aging and collection summaries; send bulk payment reminders to guardians from the same page. Scholarship awards arrive as credits on the student's invoice, clearly marked." },
            ]}
          />
        )}
