      ...
      <div className="space-y-6">
        ...
        {can("billing.read") && !isPlatform && (
          <Guide
            ...
            steps={[
              { title: "Per-seat pricing", body: "You pay per active student. Choose per-term or per-session billing — the session is your school's whole academic year and costs 15% less than paying term by term. Adding students mid-period accrues a small seat top-up you can settle any time — it's added to your next renewal otherwise." },
