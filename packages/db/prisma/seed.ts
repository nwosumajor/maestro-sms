...
const ROLE_PERMS: Record<string, string[]> = {
  ...
  principal: [
    ...
    "game.race.open", "game.race.tournament", "game.match.moderate", "game.quiz.host",
    "game.ultimate.enroll",
  ...
  teacher: ["hr.self", "task.assign", "task.participate", "poll.manage", "poll.vote",
    ...
    "game.play", "game.leaderboard.read", "game.quiz.host", "game.race.open", "game.match.moderate",
    "lms.content.read", "lms.content.write", "lms.forum.post",
    "scholarship.apply",
  ],
  student: [
