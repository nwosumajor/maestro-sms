-- =============================================================================
-- Checkers RLS + grants (CLAUDE.md three-layer tenant isolation)
-- =============================================================================
-- DELIVERED SEPARATELY FOR REVIEW. Run AFTER migration 20260714040000_checkers,
-- as the PRIVILEGED migration role.
--
-- checkers_game is tenant-scoped (non-null schoolId) with the same fail-closed
...
-- CheckersService ON TOP of this tenant isolation.
--
...
-- checkers_game_update.
-- =============================================================================

DO $$
DECLARE t text;
BEGIN
  FOREACH t IN ARRAY ARRAY['checkers_game'] LOOP
