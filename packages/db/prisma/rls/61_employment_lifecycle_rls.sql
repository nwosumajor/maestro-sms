-- =============================================================================
-- RLS: employment_change_request (tenant-scoped). SELECT/INSERT/UPDATE, NO
-- DELETE — each row is the append-only employment history (like salary changes).
-- Sentinel policy (docker-entrypoint idempotency key): employment_change_request_update
-- =============================================================================
DO $$
DECLARE t text;
BEGIN
  FOREACH t IN ARRAY ARRAY['employment_change_request'] LOOP
