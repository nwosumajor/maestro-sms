...
export const ROLE_PERMISSIONS: Record<string, readonly string[]> = {
  ...
  head_teacher: ["attendance.amend.review", "member.scan", "hr.self", "task.assign", "task.participate", "poll.vote", "discussion.participate", "discipline.file", "form.respond", "exam.release",
